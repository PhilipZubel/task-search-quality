...
class PyseriniAnceBuilder(AbstractIndexBuilder):
    ...
    def build_index(self, input_dir,  output_dir):
        ...
        self.__build_lucene_ance_index(input_dir=input_dir,
                                        output_dir=output_dir)
        
    def __build_lucene_ance_index(self, input_dir, output_dir, cpu=True):
